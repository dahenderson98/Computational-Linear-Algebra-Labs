# -*- coding: utf-8 -*-
"""Copy of SD_and_image_compression.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/17HVB_cLB2fd-strZOQ4vRdCidz6hp1ca
...
def reconstructed_array(u,s,v_t):
  sig = sigma(u.shape[0],v_t.shape[0],s)
  A = u@sig@v_t
  return A

"""**Problem 3**"""

# This function accepts an array A and an integer k, and returns a rank k approximation of A as computed by an SD.

def lower_rank(A,k):
  u,sk,v_t=np.linalg.svd(A)
  #uk = u[0:k,0:k]
  m,n=A.shape
  if sk.shape[0] > k:
    sk = sk[0:k]
  #v_tk = v_t[0:k,0:k]
  final = reconstructed_array(u,sk,v_t)
  return final
...
npa=np.array(gray_array)
m,n=npa.shape
entries = m * n
original_size=entries

"""**Problem 5**"""

# Place your plot for Problem 5 here.
u,s,v_t=np.linalg.svd(npa)
plt.plot(s)

"""**Problem 6**"""

# Save the value you obtain in Problem 6 as the variable min_rank.
#new_gray_array=lower_rank(gray_array,100)
#show_gray(new_gray_array)
min_rank=100

"""**Problem 7**"""

# Save the values you obtain in Problem 7 as the variables rank_100_size and relative_size.
#nu,ns,nv_t = np.linalg.vd(new_gray_array)
m1,n1 = u.shape
usize = m1 * 100
m2,n2 = v_t.shape
v_tsize = 100 * n2
rank_100_size = 100 + usize + v_tsize

relative_size = rank_100_size / original_size

print(rank_100_size,relative_size)
