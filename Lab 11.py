...
Original file is located at
    https://colab.research.google.com/drive/1UuM812SBVbPBlJebSi0r5BYNZLH9QGhv
...
W=(1/(X_total.shape[1]-1)) * X_total @ X_total.transpose()
X_total.shape
...
#negW=(1/(X_neg.shape[1]-1)) * X_neg @ X_neg.transpose()
#negL, negP = np.linalg.eig(negW)
#negu1 = negP[0]
#negu2 = negP[1]
